...
app.get('/api/me', (req, res) => {
  ...
  const { id, roblox_id, username, avatar_url, site_credit_cents, is_admin, bio, created_at } = req.user;
  res.json({ user: { id, roblox_id, username, avatar_url, site_credit_cents, is_admin, bio, created_at } });
});
